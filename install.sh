...
# ─────────────────────────────────────────────
# 🌸 Vapor Rice i3 Installation Script
# Декларативная установка дотфайлов для Arch Linux
# Включает автоматическую поддержку NVIDIA GPU
# ─────────────────────────────────────────────
...
ln -sf ~/dotfiles/bash/.bash_wayland_env ~/.bash_wayland_env
